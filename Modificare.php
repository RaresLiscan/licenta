...
<!--modificare-->
<h1 class="h1inserare"><?php if ($_GET['id'] != '') { echo "Modificare Inregistrare"; }?></h1>
...
<div class="forinput"><span class="forname">Poza3: </span> <input type="text" name="photo3" value="<?php echo $row->photo3;}}}?>"/><br/></div>
</div>
<br/>
