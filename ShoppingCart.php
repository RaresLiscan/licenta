...
class ShoppingCart extends DBController
{
 ...
 {
  $query = "SELECT services.*, cart.id as cart_id,cart.quantity
  FROM services, cart
  WHERE services.id = cart.service_id AND cart.id_user = ?";
 ...
 $params = array(array("param_type" => "i","param_value" => $service_id),
